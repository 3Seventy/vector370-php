...
<?php
/* Dependencies
 * To access threeseventy SDK library we must include main file
 */
require '_path_to_lib_folder_/lib/three_seventy_api.php';
/* and config */
 ...
 * getConfig() returns config array:
 */
function getConfig(){
    return array(
...
/* I think about rename getConfig() to getT70Config() or something like that 
 * to prevent conflict if user already has getConfig() method in his own code */
/*
 * So creating the Client object:
*/
$config = getConfig();
