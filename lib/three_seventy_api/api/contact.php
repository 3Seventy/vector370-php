...
use ThreeSeventyApi\Model\Contact as ContactModel;
use ThreeSeventyApi\Model\ContactAttribute;
use ThreeSeventyApi\Model\ContactAttributeCategory;
use ThreeSeventyApi\Model\ContactAttributeDefinition;
use ThreeSeventyApi\Model\ContactSubscription;
 ...
 * @see https://api.3seventy.com/docs/v2.0/Default/endpoints#!/contact
 * @see https://api.3seventy.com/docs/v2.0/Default/endpoints#!/contactattribute
 * @see https://api.3seventy.com/docs/v2.0/Default/endpoints#!/subscriptioncontact
 * @see https://api.3seventy.com/docs/v2.0/Default/endpoints#!/contactattributecategory
 * @see https://api.3seventy.com/docs/v2.0/Default/endpoints#!/contactattributedefinition
 */
class Contact {
