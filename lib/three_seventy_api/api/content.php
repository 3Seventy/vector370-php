...
use ThreeSeventyApi\Model\Content as ContentModel;
use ThreeSeventyApi\Model\ContentTemplate;
 ...
 * @see https://api.3seventy.com/docs/v2.0/Default/endpoints#!/contenttemplate
 */
class Content {
